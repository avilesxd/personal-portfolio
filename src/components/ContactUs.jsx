        ...
        <div className='w-full content-center'>
            <form autoComplete='off' ref={ form } onSubmit={ sendEmail }>
                <div className='text-center text-md md:text-xl mb-3'>
                    ...
                    <div>
                        <input type="text" name='user_name' required placeholder='Name' className='bg-slate-300 dark:bg-slate-300 rounded-lg overflow-hidden' />
                    </div>
                </div>
                ...
                <div className='text-center text-md md:text-xl mb-3'>
                    ...
                    <div>
                        <input type="email" name='user_email' required placeholder='Example@gmail.com' className='bg-slate-300 dark:bg-slate-300 rounded-lg overflow-hidden' />
                    </div>
                </div>
                ...
                <div className='text-center text-md md:text-xl mb-3'>
                    ...
                    <div>
                        <textarea name="user_message" id="" cols="30" rows="10" required placeholder='Your message' className='bg-slate-300 dark:bg-slate-300 rounded-lg overflow-hidden'></textarea>
                    </div>
                </div>
                <div className='text-center text-md md:text-xl mb-3'>
